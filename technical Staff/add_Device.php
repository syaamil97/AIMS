...
mysql_query("insert into stdevice (dev_id,dev_serial,dev_brand,dev_model,dev_status) values('$dev_id','$dev_serial','$dev_brand','$dev_model','$dev_status')")or die(mysql_error());
