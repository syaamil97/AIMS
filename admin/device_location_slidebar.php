     <div class="span3" id="sidebar">
					...
					<img id="admin_avatar" class="img-polaroid" src="<?php echo $row['adminthumbnails']; ?>"> </div>
					 <?php include('count.php'); ?>
					  ...
					  <!------/.* manage AIMS user sidebar*------->	
						<li>						
						    <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs2"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;Manage AIMS User
							<div class="muted pull-right"><i class="caret"></i></div></a>						
